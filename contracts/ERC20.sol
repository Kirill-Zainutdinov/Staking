...
contract ERC20 is IERC20 {
    ...
    modifier onlyOwner(){
        require(msg.sender == _owner || msg.sender == _stakingContract, "ERC20: You are not owner");
        _;
    }
    ...
    function setStakingConatract(address __stakingContract) external onlyOwner{
